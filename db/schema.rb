...
ActiveRecord::Schema.define(version: 20210422161349) do
  ...
  create_table "quality_filtering", force: :cascade do |t|
    t.integer "tag_prompt_deployment_id", limit: 4
  end

  add_index "quality_filtering", ["tag_prompt_deployment_id"], name: "fk_rails_d036aded23", using: :btree
  ...
  add_foreign_key "quality_filtering", "tag_prompt_deployments"
